...
class Seo extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('page_name, meta_author', 'length', 'max' => 255),
            array('meta_tags, meta_description', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, page_name, meta_tags, meta_description, meta_author', 'safe', 'on' => 'search'),
        );
    }
